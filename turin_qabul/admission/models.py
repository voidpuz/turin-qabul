...
class Admission(models.Model):
    ...
    country_of_birth = models.ForeignKey(
        "admission.Country", on_delete=models.PROTECT, related_name="birth_country_admissions", null=False, blank=False
    )

    nationality = models.ForeignKey(
        "admission.Country", on_delete=models.PROTECT, related_name="nationality_admissions", null=False, blank=False
    )
